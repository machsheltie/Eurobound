# The Legacy Vault — Card Copy

**Round 5 · Economy, Wallet & Crypto Satire System**
**Owner:** Lane V · **Status:** draft for author review
**Parent spec:** `docs/superpowers/specs/2026-07-31-economy-wallet-crypto-design.md` (§2, §6.1, §7a.2)
**Sibling docs:** `design/economy/wallet_ui.md` (tab layout, first-open modal, counter — Lane E owns), `design/economy/economy_system.md` (SOVS, kiosks, rug-pull math), `design/economy/shitcoin_master_pool.md` (Bagholder Assets side)

---

## 1. What This File Is

The Legacy Vault (Wallet Tab 1, unlocked from game start) renders one card per held asset. This
file is the **card copy** for all twelve Frat Bro NFT collection targets plus the FuncoLand
Nostalgia Series relic. Layout, framing, seals, the permanent Portfolio Thesis sub-header and the
`[N of ∞] The Legacy Vault Secured` counter live in `wallet_ui.md`; this file supplies only the
text that goes inside the frames.

**Card anatomy (per spec §2, fixed, four fields, in this order):**

| Field | Function |
|---|---|
| **Edition** | The scarcity claim. Always stated as fact, never hedged. |
| **Estimated Future Value** | Always absurdly bullish. Never a hedge, never a range that includes down. |
| **Collector's Note** | Gallery wall-text voice. Describes the artwork with complete seriousness. |
| **Acquisition Story** | Provenance, told with the gravity of an estate auction catalogue. |

### 1a. Writing rules for this file (binding)
...
> **Edition** — Historic First · Edition 1 of 1 · Origin Artifact
>
> **Estimated Future Value** — The first documented example of anything, in any medium, held by
> anybody. Consult the comparables. There are no comparables.
>
> **Collector's Note** — Shot from above, on a bedroom ceiling light, at an angle that has since
> been reproduced approximately nine hundred million times. Everything downstream of this image is
> a copy of this image.
>
> **Acquisition Story** — Obtained at the Meme Black Market, behind the shelf, after the password,
> from the archivist's own holdings. He released it personally and asked for nothing that a normal
> person would consider money. Somebody had to be the first one to take it seriously.
...
donut on a manicured lawn, stamped on a scratched aluminum token · `item_tractor_nft`*

> **Edition** — Edition 1 of 1 · Acquired via high-stakes poker  🔒
>
> **Estimated Future Value** — ████████ (Loading… still loading… extremely bullish)  🔒
>
> **Collector's Note** — Eleven frames. A zero-turn mower, a manicured lawn, and a cowboy hat
> riding one frame behind the turn. Somebody cared about that lawn. Digital land.
>
> **Acquisition Story** — Gifted by Aaron the Unflappable after drunkenly losing to his god-tier
> pocket kings. Can you FEEL IT?  🔒

**Locked-copy note (internal, not rendered):** the Edition tag, the Estimated Future Value string
...
>
> **Estimated Future Value** — Sound has never once been correctly priced at the moment of its
> making. It is always priced afterward, by people who were not there.
>
> **Collector's Note** — Twelve seconds. No music, no voice, no edit, no fade. A handshake
> protocol negotiating terms with a telephone line: the birth cry of the modern internet. Play it
> in a quiet room, at volume, all the way to the end. It does not resolve into anything. It was
> never going to. That is the piece.
>
> **Acquisition Story** — Recorded off a live line rather than sampled or reconstructed, and
> preserved at full length including the silence before the first tone. The silence is part of
> the work and is included in the twelve seconds at no additional cost to the holder. Nothing has
> been cleaned. Nothing on this master has been touched since the moment it happened.

**Locked-copy note (internal, not rendered):** "the birth cry of the modern internet" is
author-locked phrasing (§7a.2) and appears verbatim in the Collector's Note. "America Online" is a
...
## 6. Vault Relic — FuncoLand Nostalgia Series 🔒

*Not one of the twelve. Joins the Legacy Vault as a relic entry per spec §6.1 and counts toward
the `[N of ∞]` counter like any other holding.*

> **Edition** — Limited Drop · Pre-2005 Retail Artifact  🔒
>
> **Estimated Future Value** — Will outpace continental real estate by 2031  🔒
>
> **Collector's Note** — People are going to kill for this in ten years. We're early.  🔒
>
> **Acquisition Story** — Traded for a gelato. One scoop, pistachio, already paid for and already
> going soft, handed across a folding table to a man who took it without hesitating. He received
> a dessert with a shelf life of four minutes. We received a pre-2005 retail artifact. Bradley
> has described the exchange, in public, on several occasions, as the single best trade of his
> life.
...
- **To Lane E (`wallet_ui.md`):** card anatomy here matches spec §2 field order exactly. Two asks:
  the audio-card variant (§7.6), and confirmation that relic entries (FuncoLand) increment the
  `[N of ∞] The Legacy Vault Secured` counter alongside the twelve targets.
- **To Lane R (`_sorting/` retrofits):** Lane V read `fratbronft.md`, `nfthuntdebaucheryville.md`,
  `nfthuntsinfonia.md`, `publandia.md` and `tractor_nft_item.md` and **edited none of them**. If
