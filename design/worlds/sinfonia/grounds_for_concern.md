...
*Where the espresso is stronger than your convictions, the barista judges your order before you make it, and the caffeine shakes are considered a feature, not a bug*

## Location Identity
- **Location ID**: sinfonia_kaffeehausrow_grounds_concern_01
- **Display Name**: Grounds For Concern
- **Satirical Subtitle**: "Shaking Is Normal"
- **World Location**: Sinfonia
- **Area Zone**: Kaffeehaus Row, Intellectual Café District (mobile — prime locations)
- **Location Type**: Street Vendor / Espresso Stand / Speed Buffs / Debuff Risk

## Access & Requirements
### Entry Conditions
- **Time Restrictions**: 6 AM - 10 PM (caffeine has limits, apparently)
- **Stat Requirements**: None
- **Item Requirements**: Gold
- **Previous Location Requirements**: None
- **Special Conditions**: Ordering "regular coffee" triggers existential crisis in barista
...
## Visual Design
### Stand Description
- **Structure**: Compact, efficient espresso stand with gleaming brass machine
- **Equipment**: Professional La Marzocco machine (polished obsessively), grinder, steam wand
- **Display**: Minimalist — this isn't about options, it's about QUALITY
- **Signage**: 
  - Main: "Grounds For Concern — Ristretto, Espresso, Doppio"
  - Secondary: "We Do Not Serve 'Regular Coffee.' Don't Ask."
  - Tertiary: "Yes, You Will Shake. This Is Correct."
- **Décor**: Chalkboard with bean origins, tiny cup display, NO large cups visible
...
- **Color Palette**: Primary: Espresso Brown (#3C280D), Accent: Brass Gold (#B5A642), Background: Steam White (#F5F5F5), Crema Tan (#C4A35A)
...
- **Ristretto**: Respected order (you know what you want)
- **Espresso**: Acceptable (classic choice)
- **Doppio**: Understood (you need strength)
...
- **Secondary Targets**: Coffee snobbery, "authentic" European café experience
- **Cultural Specificity**: Viennese coffeehouse traditions meeting modern espresso worship
- **Humor Approach**: Barista's dedication is genuine, reactions are extreme
- **Sensitivity Considerations**: Satirizes coffee snobbery, celebrates the craft underneath

### The Speed/Risk Tradeoff
The stand's unique mechanic:
- Espresso provides Speed buffs (caffeine boost)
- But also provides Luck debuffs (the jitters)
- More shots = more speed = more jitters
- Finding the right balance is the game
- Some players will absolutely overcaffeinate for speed (consequences be damned)

## Gameplay Mechanics

### Shop System — Espresso Menu
...
**"Shaky"**:
- Visual hand tremor on character
- -10% accuracy on precision actions
- +5% critical hit chance (nervous energy)
- Dialogue options sometimes autocomplete wrong

**"Heart Racing"**:
- Screen pulse effect (subtle)
- Cannot rest or sleep until worn off
- +20% initiative in combat
- NPCs comment on your visible vibration

**"Over-Caffeinated"** (Too many drinks):
- All positive and negative effects doubled
- Random stat fluctuations
- Dialogue becomes VERY FAST
- Must wait 30 minutes or use "The Intervention"
...
**Location**: With espresso machine visible, steam rising

**Standard Photo**:
- Holding tiny espresso cup (looking confused by size)
- Steam in background
- Caption: "Authentic Experience"

**"The Vibration"** Variant:
- Post-Quadruple, visible shaking
- Multiple empty cups visible
...
- **Function**: Shop interface, caffeine effects, coffee wisdom
- **Dialogue**: 
  - "Welcome. What can I— actually, I already know. You want it strong."
  - "The extraction was 23 seconds. PERFECT. You're welcome."
  - *on sugar request* "I... can provide this. But the coffee will not forgive you."
  - *on decaf request* "Decaffeinated espresso is like... a silent symphony. What is the POINT?"
  - *on regular coffee* "There is a place three streets over. They serve... that. Go there. Please."

### The Regulars (Queue)
- **Role**: Atmosphere, ordering examples, caffeine veterans
- **Types**: Shaky writers, vibrating musicians, steady-handed coffee masters
...
- **Kaffeehaus Row**: Home district, café culture connections
- **Café Existenz**: Philosophical debates enhanced by caffeine
- **The Bassline Opera House**: Speed buff useful for rhythm combat
- **The Moderato Pub**: Coffee/beer culture clash discussions
...
### Achievement Track
- **"First Shot"**: Purchase any drink
- **"Regular"**: Reach first tolerance level
...
### Environmental Audio
- **Ambient**: Steam hiss, grinder whir, cup clinks, Kaffeehaus Row background
- **Music**: None (espresso is serious)
- **Interactive**: Portafilter lock, extraction pour, milk steam
...
- **Animation Requirements**:
  - Espresso pour (satisfying)
  - Steam clouds
  - Shaky status visual
  - Heart pulse overlay
- **Performance Budget**: 60 FPS target, max 10 draw calls, 25MB memory
- **Platform Considerations**: Simple stand, focus on steam and status effects

### Development Timeline
- **Asset Creation**: 4 hours (stand detail, steam effects)
- **Implementation Phase**: 5 hours (shop system, tolerance mechanic, status effects)
- **Testing Requirements**: Caffeine balance, status effect clarity
- **Polish Phase**: 2 hours (pour animation, steam timing)

## Quality Assurance Checklist
- [x] **World consistency verified** (Sinfonia specific)
- [x] **Cultural specificity confirmed** (Viennese coffee traditions)
- [x] **Satirical targets appropriate** (Espresso snobbery, not coffee lovers)
- [x] **Gameplay value established** (Speed buffs with risk, tolerance system)
- [x] **Sinfonia requirements met**:
  - [x] Coffeehouse culture
  - [x] High standards/gatekeeping
  - [x] Craft devotion
  - [x] European café traditions
- [x] **No crypto elements** (Pure caffeine worship)
