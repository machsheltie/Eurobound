# Plot Armor Provisions

*The food cart that knows it's keeping you alive for the story — hearty meals, maximum HP restoration, fourth wall optional*

## Location Identity
- **Location ID**: publandia_vendor_plot_armor_01
- **Display Name**: Plot Armor Provisions
- **Irish Alias**: "Soláthairtí Armúr Plota"
- **Satirical Subtitle**: "You Can't Die Yet. You Haven't Finished the Main Quest."
- **World Location**: Publandia
- **Area Zone**: Cobblestone Market Street (conveniently placed, always)
- **Location Type**: Street Vendor / Hearty Meals / Major HP Restoration / Meta-Aware Service
...
- **Completion Requirements**: No completion (you'll be back)
- **Failure States**: Cannot fail (protagonists don't fail at buying food)
- **Progressive Unlocks**: "Plot Essential" status after purchasing before 3 major events

## Visual Design
### Exterior Description
- **Structure**: Cheerful food cart, warm lighting, always positioned exactly where you need it
- **Design**: Cozy, welcoming, suspiciously convenient location
- **Cart Contents**: Hearty Irish meals, comfort food, HP restoration incarnate
- **Signage**:
  - Main: "PLOT ARMOR PROVISIONS" with shield-and-fork logo
  - Subtitle: "Keeping You Alive Since You Started Playing"
  - Banner: "Pre-Boss Specials Available • We Know You're About to Do Something Stupid"
  - Side: "Main Characters Eat Free* (*They Don't, But It Sounded Heroic)"
  - Chalkboard: "TODAY'S SPECIAL: Whatever You Need Right Now"
- **Atmosphere**: Warm, reassuring, the feeling of being protected by narrative necessity
- **Environmental Context**: Always near save points, always before difficult areas

### Cart Layout — The Protagonist's Pantry

**The Hot Station**
- Irish stew (perpetually simmering)
- Meat pies (always fresh)
- Full Irish components (ready to assemble)
- Hearty soups (rotated daily, plot-appropriate)

**The Display Case**
- Sausage rolls
- Pasties (various fillings)
- Hearty sandwiches
...
| After major loss | "Rough time? This'll help." | The Second Wind |
| Before story decision | "Important choice coming. Eat first. Think clearly." | Plot Convenience Pie |
| Main quest pivotal moment | "You're not ready. Eat this. Now you're ready." | The Protagonist's Portion |
...
### Cultural Targets
- **Primary Satirical Focus**: RPG vendor placement, game food mechanics, plot armor tropes
- **Secondary Targets**: Convenient game design, protagonist privilege, suspension of disbelief
- **Cultural Specificity**: Irish comfort food as HP restoration
- **Humor Approach**: Meta-awareness played completely sincere
...
**What bros THINK is happening**: Finding a convenient food cart

**What is ACTUALLY happening**: Being kept alive by someone who knows they're in a story

**How impaired are they**: Varies (food helps regardless)

**The plot armor experience**:
1. "Hey, a food cart! Perfect timing, I'm starving."
2. "Wait, how did you know I was about to go fight someone?"
3. "...lucky guess, I'm sure."
4. *eats food, survives fight*
5. "That food cart lady really knows her stuff."
6. *doesn't question why she's always there*
...
| Social challenge | Calm Nerves Casserole | "For when words matter." |
| Exploration | Trail Provisions | "Going somewhere interesting?" |
| Story decision | Plot Convenience Pie | "Think clearly. Eat first." |
| Main quest milestone | The Protagonist's Portion | "This is the big one." |
...
- Wherever you're about to need food (uncanny)

**Player Can't Question It**:
If player tries to ask about the convenient placement:
...
- "Perfect timing. The stew's just ready."
- "You look like you're about to do something. Come, eat first."

*The Recommendation:*
- "You'll want the Pre-Fight Fuel. Trust me."
- "Take the Fortitude Stew. You'll thank me later. Or you won't be able to, if you don't."
- "The Protagonist's Portion. Yes, it's expensive. Yes, you need it."

*Meta-Adjacent Comments:*
- "Main characters don't skip meals. It's bad for the narrative."
- "You can't save the day on an empty stomach. Well, you CAN, but it's harder."
- "I've fed a lot of heroes. You've got the look. The hungry, about-to-do-something-stupid look."
- "Don't worry about how I knew you'd be here. Just eat."

*When Questioned:*
- "How do I know? I just do. Eat your pie."
- "Why am I always in the right place? Good business instincts. Very good."
...
*Reassurance:*
- "You're going to be fine. You're the protagonist."
- "Whatever happens next, at least you won't be hungry."
- "I've seen a lot of adventurers. You'll make it. They always do. The important ones."
- "Come back after. I'll want to hear how it went. I mean, I'll KNOW, but I'd like to hear it from you."

*After Player Survives Something:*
- "See? I told you. The stew helped."
- "Back already! That means you won. I knew you would."
- "You look tired but alive. The food did its job."
- "Ready for the next one? There's always a next one."
...
**The Regular Hero**
- **Composition**: Someone clearly on their own adventure
- **Behavior**: Eating determinedly, preparing for something
- **Function**: Shows other "protagonists" being served
- **Dialogue**: "She told me to get the Fortitude Stew. Said I'd need it. She's never been wrong."
...
- "The cart goes where it's needed. I used to question it. Now I just keep the stew hot."
- "Everyone asks how I know. Nobody asks why the stew is always perfect temperature. Some mysteries are more important than others."
...
## System Integration
### Vendor Network
- **Function**: Major HP restoration, pre-event preparation, meta-humor
- **Connection to All Major Events**: Always conveniently placed
- **Connection to Save Points**: Often nearby
- **Connection to Difficulty Spikes**: Suspiciously present
- **Theme**: Plot armor made edible, narrative convenience

### Cross-Location Dependencies
- **The Stoutworks Brewery**: Appears before dungeon entrance
- **The Quiet Man**: Available before champion fight
- **Paddy's Book**: Present after major losses
...
### Achievement Track
- **First Purchase**: "Fed" — you ate
- **Followed Suggestion**: "Trusting" — she was right
- **Survived Major Event**: "Protected" — the food helped
...
- plot_armor_cart.png - 256x192 - The convenient setup
- hot_station.png - 128x128 - Stew and pies
- display_case.png - 128x96 - Grab items
- menu_board.png - 128x192 - Adaptive display
- cart_warm_glow.png - 256x192 - Atmosphere
...
- irish_stew.png - 32x32 - Classic
- meat_pie.png - 32x32 - Substantial
- sausage_roll.png - 32x24 - Quick
- beef_guinness_pie.png - 32x32 - Premium
- shepherds_pie.png - 32x32 - Comfort
- full_irish_portable.png - 48x32 - Complete recovery
- pre_fight_fuel.png - 32x32 - Combat prep
- fortitude_stew.png - 32x32 - Boss prep
- protagonists_portion.png - 48x48 - The big one
- narrative_insurance.png - 32x32 - Off-menu special

### UI Elements (6 PNGs)
- adaptive_menu_ui.png - 192x256 - Current offerings
