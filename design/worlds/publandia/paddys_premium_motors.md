...
*"We rent dreams. We collect casualties."*

## Location Identity
- **Location ID**: `publandia_outskirts_paddys_premium_motors_01`
- **Display Name**: Paddy's Premium Motors
- **Satirical Subtitle**: "Ye'll Be Grand. That's What They All Say."
- **World Location**: Publandia (Dublin parody)
- **Area Zone**: Outskirts District, edge of city near The Cloverleaf
- **Location Type**: Service Shop / Quest Trigger / Comedy Set-Piece
...
### Exit Conditions
- **Normal Exit**: Walk out the door (or drive into The Cloverleaf)
...
- **Approach**: Gravel parking lot at the edge of Publandia, where the cobblestones give way to country roads
- **Building**: Converted farmhouse turned car rental office; "PADDY'S PREMIUM MOTORS" hand-painted in fading green
...
### Interior Visuals
- **Layout**: Small reception area with counter, wall of keys, single desk
- **Counter**: Weathered wood, covered in scratches from nervous keys being slid
- **Wall Decorations**: 
  - Faded tourism posters ("VISIT PUBLANDIA'S SCENIC ROADS")
  - Map with The Cloverleaf circled in red marker, labeled "HERE BE DRAGONS"
...
- **Color Palette**: 
  - Primary: Irish Green (#228B22), Rust Brown (#8B4513)
  - Accent: Faded White (#F5F5DC), Warning Yellow (#FFD700)
  - Background: Gravel Gray (#A9A9A9), Sky Gray (#B0C4DE)
- **Lighting Setup**: 
  - Exterior: Overcast natural light, occasional sun breaks
  - Interior: Fluorescent flickering, single window letting in gray light
- **Particle Systems**: 
  - Exterior: Light rain (frequent), gravel dust when cars move
  - Interior: Dust motes in window light, cigarette smoke wisps from ashtray
- **Animation Elements**: 
...
- **Secondary Targets**: 
  - Rental car scam culture (hidden fees, "premium" insurance)
  - Tourist refusal to listen to local advice
  - European roundabout complexity vs American grid roads
  - GPS dependency when it inevitably fails
- **Cultural Specificity**: Irish driving culture, left-side roads, rural roundabouts
- **Humor Approach**: Resigned fatalism meets tourist obliviousness
- **Sensitivity Considerations**: Punching at tourist arrogance, not Irish stereotypes
...
> "He's just being dramatic. Irish people are so colorful and quirky."
...
### Primary Functions
- **Core Purpose**: Quest trigger for "The Cloverleaf of Confusion" sidequest
- **Player Actions**: 
...
- **Age**: 62
- **Appearance**: 
  - Weathered face, deep-set eyes (thousand-yard stare)
  - Worn Aran sweater, permanent cigarette behind ear
  - Wedding ring still worn (wife left in '92, never returned)
  - Calloused hands from decades of sliding keys across counters
- **Personality**: 
  - Resigned fatalism
  - Tries to warn everyone, knows no one listens
  - Dark humor about inevitable outcomes
  - Surprisingly caring in a defeated way
- **Key Trait**: Has seen too much, dead behind the eyes, still tries to help
- **Voice Direction**: Irish accent, weary, pauses before warnings as if he knows they're futile

### Key Dialogue Moments

**First Greeting:**
> "Ah, Americans. Wanting to see the countryside, are ye?"

**The Warning:**
> *thousand-yard stare* "That's what they all say."

**The Prophecy:**
> *sliding keys across counter* "God help ye. Especially at the Cloverleaf."

**The Explanation (if asked):**
> "The Cloverleaf? It's... it's where the roads meet. And don't meet. And meet again. Forever. Some say it's a roundabout. I say it's a test of the soul. Ye'll understand. Everyone understands. Eventually."

**About His Wife:**
> *touching wedding ring* "She went for a quick drive in '92. 'Just to see the cliffs,' she said. The car came back. She didn't. They say she's still circling. I like to think she's happy."

**Post-Quest Return:**
> "Ye made it out. Most don't, ye know. At least not with their sanity. Ye've earned my respect. Doesn't mean much. But ye've earned it."
...
### Environmental Audio
- **Ambient Soundscape**: 
  - Light rain on gravel
  - Distant sheep
  - Occasional car passing
  - Wind through open door
- **Interior Sounds**:
  - Fluorescent buzz
...
### Interactive Audio
- **Door bell**: Ancient jingle when entering
- **Keys sliding**: Deliberate, weighted sound
- **Paperwork signing**: Pen scratching, paper rustling
- **GPS activation**: Cheerful startup sound (ironic)

### Comedy Audio Stingers
- **Thousand-yard stare moment**: Subtle ominous drone
- **"Cloverleaf" mention**: Distant, echoing car horns
- **Signing paperwork**: Ominous music sting (brief)
- **"That's what they all say"**: Record scratch
...
### Directly Adjacent
- **The Cloverleaf (Roundabout)**: East, 1km down the road - visible from parking lot
- **Publandia City Center**: West, 3km back toward civilization
- **Country Roads**: North/South - scenic, sheep-filled, eventually lead back to Cloverleaf
...
- **Performance Budget**: 
  ...
  - Max Draw Calls: 15
  - Memory Budget: 20MB
  - Particle Limit: 15 (rain, smoke)
- **Platform Considerations**: Simple indoor/outdoor transition

### State Tracking
```
paddys_premium_motors_state:
  - visited: boolean
  - rented_car: boolean
  - which_vehicle: string
  - purchased_gps: boolean
...
- [x] **World consistency verified** - Uses "Publandia"
- [x] **Cultural specificity confirmed** - Irish driving culture, left-side roads
- [x] **Satirical targets appropriate** - Tourist overconfidence, rental scams
- [x] **Gameplay value established** - Quest trigger, shop, character moment
- [x] **Technical feasibility confirmed** - Simple building interior/exterior
- [x] **No crypto elements** - None
- [x] **Seedy underbelly present** - Wife's disappearance, exploitation of tourists
...
### The Board of Shame
A corkboard covered in Polaroid photos of abandoned rental cars:
- 1987 minivan (still circling, according to notes)
- German sedan, 1995
- American rental, 2003 (license plate: "VACAY-1")
- Multiple recent additions with dates
- One empty spot with note: "Reserved for next"

### The Counter
"DAYS SINCE LAST CLOVERLEAF INCIDENT"
- Stuck on 0
- Dust suggests it's never moved
- Small print: "Record: 0 (achieved every day since 1984)"
...
- Back of photo visible: "MARY - CLOVERLEAF '92"
- Wedding ring worn, never removed
