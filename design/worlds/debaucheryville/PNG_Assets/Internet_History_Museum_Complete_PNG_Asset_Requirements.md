# Internet History Museum - Complete PNG Asset Requirements

## 📋 Overview
This document provides exact specifications for all PNG files needed for the Internet History Museum - where nostalgia weaponized and left to rot creates a cursed yearbook for every regrettable digital moment between 1995 and 2007.
...
## 🏛️ Sprite Sheet 1: Museum Exterior
**File:** `museum_exterior.png`  
**Dimensions:** 512x384 pixels  
**Color Palette:** #4169E1 (CRT blue), #FF6EC7 (vaporwave pink), #A9A9A9 (dusty grey)

### Building Facade:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Blockbuster Shape | (0, 0) | 512x256 | Former video store converted |
| Floppy Disk Boards | (0, 256) | 64x64 | Boarding material |
| AOL Caution Tape | (64, 256) | 128x32 | "AOL USERS ONLY" |
| Jewel Case Patches | (192, 256) | 64x64 | Doorframe repairs |

### Signage:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Banner Normal | (0, 288) | 256x48 | Comic Sans text |
| Banner Glitch 1 | (256, 288) | 256x48 | Character swap |
| Banner Glitch 2 | (0, 336) | 256x48 | Different glitch |
| 404 Error Sign | (256, 336) | 96x48 | With pigeon damage |
| ZOMG Graffiti | (352, 336) | 96x32 | "ZOMG LOL WTF M8?" |

### Props:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Dead PalmPilot | (448, 256) | 32x48 | Security camera style |
| Pigeon Nest | (480, 256) | 32x32 | Atop 404 sign |

---

## 📞 Sprite Sheet 2: Hall of Modems
**File:** `hall_of_modems.png`  
**Dimensions:** 384x256 pixels  

### Shrine Elements:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Shrine Base | (0, 0) | 256x192 | Reverent display setup |
| 56k Modem | (0, 192) | 64x32 | Sacred artifact |
| 28k Modem | (64, 192) | 56x28 | Older relic |
| External Modem | (120, 192) | 72x36 | Desktop model |
| Lights On | (192, 192) | 48x16 | Activity LEDs |
| Lights Off | (240, 192) | 48x16 | Inactive state |

### Audio Visualization:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Plaque | (256, 0) | 128x96 | Academic description |
| Screech Wave 1 | (256, 96) | 64x32 | Dial-up visual |
| Screech Wave 2 | (320, 96) | 64x32 | Building |
| Screech Wave 3 | (256, 128) | 64x32 | Crescendo |

---

## 🌐 Sprite Sheet 3: GeoCities Diorama
**File:** `geocities_diorama.png`  
**Dimensions:** 512x384 pixels  

### Diorama Elements:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Diorama Base | (0, 0) | 384x256 | Full exhibit setup |
| Star 1 | (0, 256) | 16x16 | Twinkling GIF |
| Star 2 | (16, 256) | 16x16 | Different twinkle |
| Star 3 | (32, 256) | 16x16 | Third frame |
| Construction GIF 1 | (48, 256) | 64x32 | Under construction |
| Construction GIF 2 | (112, 256) | 64x32 | Alternate frame |
| Pixelated Wizard | (176, 256) | 48x64 | GeoCities mascot |

### Interactive Kiosk:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Kiosk Inactive | (384, 0) | 128x192 | Normal hours |
| Kiosk Active (3:33 AM) | (384, 192) | 128x192 | Password puzzle |
| VHS Shelf Passage | (224, 256) | 96x64 | Hidden Meme Black Market |

---

## 🔥 Sprite Sheet 4: Angelfire Wall
**File:** `angelfire_wall.png`  
**Dimensions:** 384x256 pixels  

### Wall Elements:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Wall of Flames | (0, 0) | 384x192 | Fire background |
| Loading Bar Frame | (0, 192) | 256x32 | Progress container |
| Loading Bar Fill | (0, 224) | 223x24 | 87% forever |
...
## 🚔 Sprite Sheet 5: Habbo Crime Scene
**File:** `habbo_crime_scene.png`  
**Dimensions:** 384x256 pixels  

### Crime Scene:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Scene Setup | (0, 0) | 256x192 | Full exhibit |
| Yellow Smiley Knife | (256, 0) | 64x64 | THE artifact |
| Velvet Rope | (0, 192) | 192x32 | Barrier |
| Crime Tape | (192, 192) | 128x24 | Police style |
| Evidence Marker 1 | (256, 64) | 24x32 | Numbered marker |
| Evidence Marker 2 | (280, 64) | 24x32 | Numbered marker |
| Evidence Marker 3 | (304, 64) | 24x32 | Numbered marker |
| Pools Closed Plaque | (320, 192) | 64x64 | Memorial text |

**Status Effect:** Viewing while drunk → Pixel PTSD (screen shakes during dialogue)

---

## 💀 Sprite Sheet 6: MSN Messenger Graveyard
**File:** `msn_graveyard.png`  
**Dimensions:** 384x256 pixels  

### Graveyard Elements:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Graveyard Setup | (0, 0) | 256x192 | Devotional display |
| Webcam 1 | (0, 192) | 32x32 | Broken |
| Webcam 2 | (32, 192) | 32x32 | Cracked |
| Webcam 3 | (64, 192) | 32x32 | Defunct |
| Status Light On | (96, 192) | 16x16 | Green glow |
| Status Light Off | (112, 192) | 16x16 | Dark |
| Status Flickering | (128, 192) | 16x16 | Inconsistent |
| Tombstone 1 | (256, 0) | 64x96 | MSN RIP |
| Tombstone 2 | (320, 0) | 64x96 | AIM memorial |
| AIM Door Icon | (256, 96) | 32x32 | Sound trigger |

---

## 🕯️ Sprite Sheet 7: Darkroom iMac Altar
**File:** `darkroom_altar.png`  
**Dimensions:** 384x256 pixels  

### Altar Elements:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Altar Setup | (0, 0) | 256x192 | Religious display |
| iMac G3 Cracked | (256, 0) | 96x80 | Sacred hardware |
| Screen Glow | (256, 80) | 64x48 | CRT illumination |
| Incense Holder | (0, 192) | 24x32 | Burning |
| Smoke Frame 1 | (24, 192) | 24x48 | Rising |
| Smoke Frame 2 | (48, 192) | 24x48 | Drifting |
| Smoke Frame 3 | (72, 192) | 24x48 | Dissipating |
| CD DO NOT OPEN 1 | (96, 192) | 32x32 | Warning label |
| CD DO NOT OPEN 2 | (128, 192) | 32x32 | Burned disc |
| Pilsner Mix CD | (160, 192) | 32x32 | Lore unlock |

**Lore Trigger:** Examining CDs reveals Lord Pilsner's embarrassing teen mix CDs

---

## 🧸 Sprite Sheet 8: Furbies Exhibit
**File:** `furbies_exhibit.png`  
**Dimensions:** 384x256 pixels  

### Exhibit Elements:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Exhibit Setup | (0, 0) | 256x192 | Display arrangement |
| Furby 1 | (0, 192) | 32x40 | Defunct |
| Furby 2 | (32, 192) | 32x40 | Dead eyes |
| Furby 3 | (64, 192) | 32x40 | Silent |

### Chuck E. Cheese Animatronic (CRITICAL):
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Staring | (256, 0) | 96x128 | Blank, horrifying |
| Eyes Tracking | (352, 0) | 32x32 | Overlay for movement |

**Visual Notes:** Nobody explains why Chuck E. Cheese animatronic is in Furbies exhibit. Eyes occasionally track player movement.

---

## 📺 Sprite Sheet 9: CRT Monitor Array
**File:** `crt_monitors.png`  
**Dimensions:** 512x256 pixels  

### Monitor Frames (64x56 each):
| Frame | Position | Description |
|-------|----------|-------------|
| Beige CRT | (0, 0) | Classic 90s |
| Grey CRT | (64, 0) | Later model |
| Cracked CRT | (128, 0) | Damaged |

### Vaporwave Screens (48x40 each):
| Screen | Position | Description |
|--------|----------|-------------|
| Screen 1 | (0, 56) | Pink/blue gradient |
| Screen 2 | (48, 56) | Grid pattern |
| Screen 3 | (96, 56) | Palm trees |
| Screen 4 | (144, 56) | Roman bust |

### Flicker States:
| State | Position | Size | Description |
|-------|----------|------|-------------|
| Normal | (192, 56) | 48x40 | Stable |
| Flicker 1 | (240, 56) | 48x40 | Static burst |
| Flicker 2 | (288, 56) | 48x40 | Roll |

---

## 👤 Sprite Sheet 10: Museum NPCs
**File:** `museum_npcs.png`  
**Dimensions:** 256x192 pixels  

### Museum Curator (64x96 each):
| State | Position | Description |
|-------|----------|-------------|
| Idle | (0, 0) | Academic posture |
| Explaining | (64, 0) | Gesturing reverently |
| Reverent | (128, 0) | Treating garbage as art |

**Curator Notes:** Oversized glasses, turtleneck, speaks with academic seriousness about internet garbage

### Nostalgic Visitor (64x96 each):
| State | Position | Description |
|-------|----------|-------------|
...
|------|----------|-------------|
| Cringe | (0, 0) | MIDI negative roll |
| Inspired | (32, 0) | MIDI positive roll |
| Impatient | (64, 0) | Angelfire debuff |
| Pixel PTSD | (96, 0) | Habbo drunk effect |

### Title Badges (64x32 each):
| Badge | Position | Description |
|-------|----------|-------------|
| Patience Saint | (0, 32) | 5-minute achievement |
| Curator Cursed | (64, 32) | All plaques + Mentally Unwell |

### Other UI:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Plaque Frame | (0, 64) | 192x96 | Exhibit text display |
| Loading Bar Frame | (0, 160) | 160x24 | Angelfire timer |
| Loading Bar Fill | (0, 184) | 139x16 | 87% always |
...
|----------|----------|------|-------------|
| Dust Mote 1 | (0, 0) | 8x8 | Static glow |
| Dust Mote 2 | (8, 0) | 8x8 | Variant |
| Dust Mote 3 | (16, 0) | 8x8 | Variant |
| MIDI Sparkle 1 | (0, 8) | 16x16 | Pink |
| MIDI Sparkle 2 | (16, 8) | 16x16 | Cyan |
| MIDI Sparkle 3 | (32, 8) | 16x16 | Yellow |

### Screen Effects:
| Effect | Position | Size | Description |
|--------|----------|------|-------------|
| Static Frame 1 | (0, 24) | 48x40 | Interference |
...
### Glitching Banner:
- **Pattern:** Normal → Glitch 1 → Normal → Normal → Glitch 2 → Normal
- **Timing:** Random 0.5-2 seconds between states
- **Glitch Duration:** 0.1 seconds

### GeoCities Stars:
- **Pattern:** Star 1 → 2 → 3 → 2 (loop)
- **FPS:** 2
- **Purpose:** Authentic twinkling GIF aesthetic

### Angelfire Flames:
- **Pattern:** Frame 1 → Frame 2 (loop)
- **FPS:** 4
- **Purpose:** Eternal loading atmosphere

### Incense Smoke:
- **Pattern:** Smoke 1 → 2 → 3 (loop)
- **FPS:** 3
- **Movement:** Upward drift from altar
- **Purpose:** Religious reverence for electronics

### Animatronic Eyes:
- **Pattern:** Staring → Eyes Tracking → Staring
- **Idle Duration:** Random 10-30 seconds
- **Tracking Duration:** 2 seconds
- **Trigger:** Player movement in exhibit

### CRT Flicker:
- **Pattern:** Normal → Flicker 1 → Normal → Flicker 2 → Normal
- **Timing:** Varied per monitor, random 3-8 seconds
- **Purpose:** Authentic degraded technology
...
### Required PNG Files (12 Total):
- [ ] `museum_exterior.png` (512x384)
- [ ] `hall_of_modems.png` (384x256)
- [ ] `geocities_diorama.png` (512x384)
- [ ] `angelfire_wall.png` (384x256)
- [ ] `habbo_crime_scene.png` (384x256)
- [ ] `msn_graveyard.png` (384x256)
- [ ] `darkroom_altar.png` (384x256)
- [ ] `furbies_exhibit.png` (384x256)
- [ ] `crt_monitors.png` (512x256)
- [ ] `museum_npcs.png` (256x192)
- [ ] `museum_ui.png` (256x256)
- [ ] `museum_effects.png` (256x192)
