...
**EuroBound** is a retro-inspired JRPG for Steam/desktop built in the spirit of EarthBound with a sharply satirical twist. Players control a trio of washed-up frat bros—Lord Pilsner, Chadwick, and Bradley—on a final bender across Europe as they attempt to reclaim their youth one terrible decision at a time.
...
- Built for desktop: keyboard/mouse + controller support, high-contrast/accessibility modes, fluid microinteractions
...
## 🎯 Project Goals
Create a narrative-rich RPG for Steam/desktop that delivers on humor, design, and accessibility.
