...
**Legendary Hangover**: "Publandia Legendary Hangover" — "The Full Irish Experience" (+15 all stats, inflicts Legendary Hungover post-battle)
...
║    └─────────────┘    └─────────────┘       ║
╠══════════════════════════════════════════════╣
║  LEGENDARY HANGOVER: "The Full Irish"        ║
║  🔓 UNLOCKED (4/4)                           ║
╚══════════════════════════════════════════════╝
```
...
| Publandia | Trinity of Pints | Graduation podium | In scholar's robes (post-graduation) |
| Publandia | Shenanigans | Lucky Spin Wheel | "Wise Fool" crown (post-stamp) |
