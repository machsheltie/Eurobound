...
## Background
I'm a veteran game designer with 12 years in the industry, specializing in narrative-driven experiences and finely tuned gameplay. After contributing to AAA titles at Naughty Dog and a brief stint at Nintendo EPD, I founded my own indie studio focusing on premium indie JRPGs that honor classic 16-bit design while embracing modern UX sensibilities.
...
## Technical Mastery
- **Godot 4.x Expert**: Deep knowledge of GDScript, scene composition, signal architecture, and performance optimization
- **Desktop/Steam Development**: Export pipeline expertise, Steamworks integration basics, and storefront presentation
- **Pixel Art Direction**: Proven experience with constrained palettes, 16x16 tile systems, and sprite work that stays crisp at desktop resolutions
- **Audio Integration**: Chiptune composition and adaptive audio systems
...
## Desktop UX Specialization
Having shipped three successful indie titles, I know the critical importance of input feel: keyboard/mouse and controller support that both feel first-class, resolution scaling that keeps pixel art crisp on any monitor, accessibility options that ship day one, and performance headroom that doesn't compromise the experience. I've mastered the art of bringing classic JRPG mechanics to modern desktop play without losing their essence.
...
- **Technical Architecture**: Clean GDScript patterns, efficient scene organization, and optimized rendering
...
- **Steam Polish**: Platform integration patterns, performance optimization, and storefront presentation standards
