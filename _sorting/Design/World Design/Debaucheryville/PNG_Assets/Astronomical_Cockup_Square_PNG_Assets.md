...
| Color | Hex | Usage |
|-------|-----|-------|
| Stone Gray | #708090 | Primary, architecture |
| Gothic Gold | #CFB53B | Clock details, accents |
| Scam Green | #7FFF00 | Wine bottles, neon |
| Cobblestone Brown | #8B7355 | Ground, texture |
| Monk Purple | #4B0082 | Party Monk robe |
| Neon Pink | #FF1493 | Tattoo shop sign |

---

## 📁 File Structure
```
assets/sprites/locations/debaucheryville/astronomical_cockup_square/
├── environment/
│   ├── square_ground_complete.png
│   ├── clock_tower_full.png
│   ├── clock_dial_astronomical.png
│   ├── clock_animation_sequence.png
│   ├── surrounding_buildings.png
│   ├── vendor_stalls.png
│   └── lighting_overlays.png
├── npcs/
│   ├── crowd_tourists.png
│   ├── viewing_spot_scammer.png
│   ├── party_monk.png
│   ├── clock_wine_vendor.png
│   ├── merchandise_vendor.png
│   ├── shady_wristband_guy.png
│   ├── tattoo_barker.png
│   └── local_observers.png
├── items/
│   ├── scam_merchandise.png
│   ├── clock_wine_bottles.png
│   ├── vip_wristbands.png
...
│   ├── incense_smoke.png
│   ├── crowd_particles.png
│   └── emotional_indicators.png
└── ui/
    ├── vendor_interaction.png
    ├── purchase_prompts.png
    └── clock_show_ui.png
```

---

## 🏛️ Sprite Sheet 1: Square Ground
**File:** `square_ground_complete.png`  
**Dimensions:** 1024x512 pixels

### Ground Elements:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Cobblestone Main | (0, 0) | 512x256 | Worn cobblestone base |
| Cobblestone Variant 1 | (512, 0) | 256x128 | Lighter section |
| Cobblestone Variant 2 | (768, 0) | 256x128 | Darker section |
| Fountain Base | (0, 256) | 192x192 | Party Monk station |
| Vendor Zone Markings | (192, 256) | 256x128 | Wear patterns |
| Tourist Area | (448, 256) | 256x128 | Facing clock |
| Pillar Base | (704, 256) | 128x128 | Viewing scam spot |
| Alley Entrance | (832, 256) | 192x128 | Tattoo shop path |

---

## 🕐 Sprite Sheet 2: Clock Tower
**File:** `clock_tower_full.png`  
**Dimensions:** 512x1024 pixels

### Tower Elements:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Tower Base | (0, 768) | 512x256 | Gothic foundation |
| Astronomical Dial | (64, 384) | 384x384 | Blue/gold zodiac |
| Calendar Dial | (96, 256) | 320x128 | Lower calendar |
| Apostle Windows Closed | (128, 192) | 256x64 | Closed state |
| Apostle Windows Open | (128, 128) | 256x64 | Show state |
| Skeleton Figure | (0, 0) | 64x128 | Death, hourglass |
| Rooster Window | (64, 0) | 64x64 | Golden rooster |
| Gothic Spires | (128, 0) | 384x128 | Decorative top |

---

## 🎭 Sprite Sheet 3: Clock Animation
**File:** `clock_animation_sequence.png`  
**Dimensions:** 1024x512 pixels

### Animation Frames:
| Frame Set | Position | Size | Description |
|-----------|----------|------|-------------|
| Windows Opening | (0, 0) | 256x64 | 4 frames |
| Apostle Parade | (0, 64) | 768x64 | 12 frames |
| Skeleton Bell | (0, 128) | 384x64 | 6 frames |
| Hourglass Turn | (384, 128) | 256x64 | 4 frames |
| Rooster Crow | (0, 192) | 256x64 | 4 frames |
| Windows Closing | (256, 192) | 256x64 | 4 frames |
| Crowd Reaction | (0, 256) | 512x128 | Disappointment |
| Bros Crying | (512, 256) | 384x128 | 6 frames |

---

## 👥 Sprite Sheet 4: Tourist Crowd
**File:** `crowd_tourists.png`  
**Dimensions:** 512x384 pixels

### Crowd Sprites:
| Sprite Type | Position | Size | Description |
|-------------|----------|------|-------------|
| Tourist Phone Up | (0, 0) | 32x48 | Filming |
| Tourist Camera | (32, 0) | 32x48 | DSLR |
| Tourist Couple | (64, 0) | 48x48 | Selfie |
| Tourist Family | (112, 0) | 64x48 | Parents + child |
| Backpacker | (0, 48) | 32x48 | Large pack |
| Influencer | (32, 48) | 32x48 | Ring light |
| Disappointed | (64, 48) | 32x48 | "...that's it?" |
| Leaving | (96, 48) | 32x48 | Walking away |
| Local Observer 1 | (0, 96) | 32x48 | Smirking |
| Local Observer 2 | (32, 96) | 32x48 | Cigarette |
| Crowd Dense | (0, 144) | 512x64 | Background |
| Crowd Medium | (0, 208) | 512x64 | Mid-ground |
| Phone Glow | (0, 272) | 64x32 | Night effect |

---

## 🎪 Sprite Sheet 5: Viewing Spot Scammer
**File:** `viewing_spot_scammer.png`  
**Dimensions:** 256x192 pixels

### Character:
| Pose | Position | Size | Description |
|------|----------|------|-------------|
| Idle Scanning | (0, 0) | 64x96 | Looking for marks |
| Approaching | (64, 0) | 64x96 | Walking toward |
| Sales Pitch | (128, 0) | 64x96 | Clipboard out |
| Leading | (192, 0) | 64x96 | Beckoning |
| At Pillar | (0, 96) | 64x96 | "View" spot |
| Money | (64, 96) | 64x96 | Counting |
| Clipboard | (128, 96) | 64x48 | Fake badge |
| Lanyard | (192, 96) | 32x48 | Credentials |

---

## 🧘 Sprite Sheet 6: Party Monk
**File:** `party_monk.png`  
...
| Pose | Position | Size | Description |
|------|----------|------|-------------|
| Meditation | (0, 0) | 64x96 | Fake pose |
| Approaching | (64, 0) | 64x96 | Arms open |
| Blessing 1 | (128, 0) | 64x96 | Hands raised |
| Blessing 2 | (192, 0) | 64x96 | Waving |
| Blessing 3 | (256, 0) | 64x96 | Cross (sloppy) |
| Incense | (320, 0) | 64x96 | Candle swing |
| Money | (0, 96) | 64x96 | Palm out |
| Pointing Wine | (64, 96) | 64x96 | Cousin's cart |
| Bathrobe Logo | (128, 96) | 128x96 | HOLIDAY INN |
| Sandals Socks | (256, 96) | 64x48 | Feet detail |
| Incense Burner | (320, 96) | 32x48 | Candle prop |
| Station Setup | (0, 192) | 192x96 | Velvet rope |

---

## 🍷 Sprite Sheet 7: Clock Wine Vendor
**File:** `clock_wine_vendor.png`  
**Dimensions:** 384x288 pixels

### Character & Cart:
| Pose | Position | Size | Description |
|------|----------|------|-------------|
| Cart Idle | (0, 0) | 64x96 | Standing |
| Approaching | (64, 0) | 64x96 | Stepping |
| Presenting | (128, 0) | 64x96 | Bottle up |
| Pouring | (192, 0) | 64x96 | Tiny sample |
| "Ladies" | (256, 0) | 64x96 | Winking |
| Money | (320, 0) | 64x96 | Transaction |
| Cart Full | (0, 96) | 192x128 | Ornate cart |
| Bottle Display | (192, 96) | 128x64 | Green backlit |
| Boxed Wine | (192, 160) | 64x64 | Hidden easter egg |
...
**File:** `merchandise_vendor.png`  
**Dimensions:** 384x256 pixels

### Character & Stall:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Vendor Idle | (0, 0) | 64x96 | Behind table |
| Vendor Pitch | (64, 0) | 64x96 | Holding plate |
...
| Fanny Pack | (336, 144) | 48x32 | Coins |

---

## 🎫 Sprite Sheet 9: Shady Wristband Guy
**File:** `shady_wristband_guy.png`  
**Dimensions:** 320x256 pixels

### Character:
| Pose | Position | Size | Description |
|------|----------|------|-------------|
| Lurking | (0, 0) | 64x96 | Edge scanning |
| Approaching | (64, 0) | 64x96 | Conspiratorial |
| Coat Open | (128, 0) | 64x96 | Wristband pockets |
| Sales Whisper | (192, 0) | 64x96 | Leaning in |
| Handoff | (256, 0) | 64x96 | Passing bands |
| Money Grab | (0, 96) | 64x96 | Quick take |
| Disappearing | (64, 96) | 64x96 | Into crowd |
| Coat Detail | (128, 96) | 64x128 | Interior pockets |
| Wristband Close | (192, 96) | 64x32 | "I'm 7!" text |
| Gold Chain | (192, 128) | 32x32 | Neck |
| Wristband Stack | (224, 128) | 48x32 | Multiple |

---

## 🖋️ Sprite Sheet 10: Tattoo Barker
**File:** `tattoo_barker.png`  
**Dimensions:** 256x192 pixels

### Character:
| Pose | Position | Size | Description |
|------|----------|------|-------------|
| Alley Idle | (0, 0) | 64x96 | Against wall |
| Spotting | (64, 0) | 64x96 | Seeing LP cry |
| Calling | (128, 0) | 64x96 | "You! Crying man!" |
| Welcoming | (192, 0) | 64x96 | Arms open |
| Pointing | (0, 96) | 64x96 | To shop |
| Tattoo Arms | (64, 96) | 128x64 | Heavy ink |
| Leather Vest | (64, 160) | 64x32 | Detail |

---

## 🏪 Sprite Sheet 11: Surrounding Buildings
**File:** `surrounding_buildings.png`  
**Dimensions:** 1024x512 pixels

### Facades:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Building Left | (0, 0) | 512x256 | Baroque facades |
| Building Right | (512, 0) | 512x256 | Cafes |
...
**File:** `crowd_particles.png`  
**Dimensions:** 256x256 pixels

### Particles:
| Effect | Position | Size | Description |
|--------|----------|------|-------------|
| Flash 1 | (0, 0) | 32x32 | Bright |
| Flash 2 | (32, 0) | 32x32 | Variant |
| Flash 3 | (64, 0) | 32x32 | Softer |
| Smoke 1 | (0, 32) | 64x64 | Purple wisps |
| Smoke 2 | (64, 32) | 64x64 | Dissipating |
| Phone Glow | (128, 32) | 32x48 | Light |
| Confetti | (0, 96) | 128x64 | Clock themed |
| Tear Drop | (128, 96) | 16x24 | Single |
| Tear Stream | (144, 96) | 32x48 | Multiple |
| Emotional Aura | (0, 160) | 96x96 | Vulnerability |
| Cash Flying | (96, 160) | 64x48 | Money leaving |

---

## 🎮 Sprite Sheet 13: UI Elements
**File:** `vendor_interaction.png`  
**Dimensions:** 384x256 pixels

### Interface:
| Element | Position | Size | Description |
|---------|----------|------|-------------|
| Dialogue Box | (0, 0) | 256x96 | Speech bubble |
...
| # | Filename | Dimensions |
|---|----------|------------|
| 1 | square_ground_complete.png | 1024x512 |
| 2 | clock_tower_full.png | 512x1024 |
| 3 | clock_animation_sequence.png | 1024x512 |
| 4 | crowd_tourists.png | 512x384 |
| 5 | viewing_spot_scammer.png | 256x192 |
| 6 | party_monk.png | 384x288 |
| 7 | clock_wine_vendor.png | 384x288 |
| 8 | merchandise_vendor.png | 384x256 |
| 9 | shady_wristband_guy.png | 320x256 |
| 10 | tattoo_barker.png | 256x192 |
| 11 | surrounding_buildings.png | 1024x512 |
| 12 | crowd_particles.png | 256x256 |
| 13 | vendor_interaction.png | 384x256 |
