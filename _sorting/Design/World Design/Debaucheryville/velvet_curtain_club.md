...
If the bros have already entered the club before getting the wristbands, the entire joke falls flat.
...
*Quest hint triggers: "Find VIP access in Astronomical Cock-Up Square"*

### Gameplay Effect
- Club entrance is **blocked** until wristbands acquired
- Bouncer gives vague "VIP" hint
- Guides players toward Astronomical Cock-Up Square
- Prevents breaking the comedy sequence
...
### When Bros Return WITH "Level Seven" Wristbands
...
*There is no line. The club is free to enter. The same bouncer is checking his phone.*

**BRADLEY:** "There's no line."

**LORD PILSNER:** "That's because word got out we were coming. They cleared it."

### The Bouncer Confrontation

*Bros stride up to bouncer*
...
## 🔄 Bouncer Behavior - Subsequent Visits

### Running Gag Integration
...
- **Approach**: Hidden entrance down graffiti-laced alley behind opera house ruins billboard
- **Entrance**: Heavy velvet curtain as only door, subtly pulsating with music bass
- **Guard**: Cybernetic-eyed bouncer at velvet-rope checkpoint
- **Signage**: "✨ Vibes Only. No Shoes? No Dignity? You're In."
- **Atmosphere**: Distant glitchy lounge-techno bass, dead-end service lane contrasts opulent interior
- **Environmental Context**: Graffiti dumpster mural, between service entrances

### Interior Description
- **Layout**: Open nightclub floor with semicircular crushed velvet booths
- **Lighting**: Deep burgundy fog, LED underglow on booths, flickering LEDs
- **Chandeliers**: Made of crushed vape pens and crystal teardrops
- **Decor**: Gold-plated stripper poles serving as coat racks
- **DJ Booth**: Dais shaped like a broken throne
- **Neon Signs**: Cryptic phrases like "The Real Party's in Your Head"
- **VIP Bathroom**: Behind 'Staff Only' curtain (NFT hunt location)
- **Furniture & Props**:
  - Semicircular crushed velvet booths
  - Cracked mirror art installation
...
- **Lighting Setup**: 
  ...
  - Chandelier sparkle effects
  - DJ booth spotlight
- **Particle Systems**: Fog machine effects, vape clouds, light beams
- **Animation Elements**: 
  - Neon sign flicker
...
### Before 22:00 (Pre-Peak)
- Minimal crowd
- Setup happening
- Bouncer less strict (but still requires wristbands for comedy)
- DJ doing sound check
- Vanessa arrives early, claims best spot

### 22:00 - 02:00 (Peak Hours)
- Full atmosphere
- Maximum patron density
- All NPCs active
- Best time for quests
- Influencer Blood Ritual can trigger

### After 02:00 (Late Night)
- Crowd thinning
- Desperate energy
- "Last call" dialogue options
- Vanessa more likely to offer couchsurfing
- Emotional conversations unlock
...
- **Appearance**: Crystal jewelry, flowing dark clothes, ever-present vape (peach-mango clouds)
- **Personality**: Believes in "energy" and "vibes," sells crystal NFTs
- **Location**: Main floor, near bar
...
### The Bouncer (Tomáš)
- **Role**: Entry gate / Comedy straight man / Running gag participant
- **NPC File**: See `npc_velvet_curtain_bouncer.md`
...
- **NPC File**: See `npc_second_bouncer.md`
- **Key Line**: "Měl by dostat dětské menu." (He should get the children's menu.)

### DJ "Sound Alchemist"
- **Role**: Atmosphere / Background
- **Location**: Broken throne dais
- **Personality**: Pretentious, never speaks to patrons
- **Key Detail**: Insists on being called "Sound Alchemist" not "DJ"

### VIP Bathroom Attendant
- **Role**: NFT hunt guide
- **Location**: Staff Only area
- **Function**: Hints at graffiti QR codes
...
| Opera Cloak Thrift Shopper | Ravewear mixed with vintage opera costume |
| Emotional Damage Drinker | Only drinks cocktails "made with rare emotional damage" |

### Patron Dialogue Samples
> "He said he was a 'sound alchemist.' I think that means DJ."

> "I only drink cocktails made with rare emotional damage."

> "Those Americans? The 'Level Seven' guys? They've been flashing those wristbands at everyone."

> "Is it your birthday?" *(to bros - they don't understand why)*
...
### Entry Quest Gate
- **Required**: VIP Wristband from Shady Wristband Guy
- **Quest**: "The VIP Experience" (`debaucheryville_sidequest_vip_wristbands_01`)
- **Trigger**: Bouncer scene upon first entry with wristbands

### Available Quests Inside
| Quest | Type | Description |
|-------|------|-------------|
| Club Flyers | Side Quest | Vanessa asks bros to distribute flyers |
| Influencer Blood Ritual | Side Event | Fake goth influencer attempts to summon followers via absinthe |
| NFT Hunt: Pixelated Kebab Monkey | Collectible | QR graffiti in VIP bathroom stall |
| Couchsurfing: Vape Witch Vanessa | Social | Crystal quiz, potential accommodation |
...
- **ICQ Integration**: CryptoMamiXXX messages mock player decisions
...
| Sound | Volume | Notes |
|-------|--------|-------|
| Glitchy lounge-techno | 70% | DJ's "sound alchemy" |
| Crowd murmur | 40% | Pretentious conversations |
| Bass pulse | 30% | Felt more than heard |
| Vape exhales | 15% | Background texture |
| Glass clinking | 20% | Bar service |
| Fog machine hiss | 10% | Atmosphere |

### Audio Transitions
- **Alley approach**: Muffled bass, anticipation
- **Entry through curtain**: Bass impact + atmosphere shift
- **VIP bathroom**: Echo shift, quieter music
- **Exit**: Music fades, alley ambient returns

### Triggered Audio
| Trigger | Sound |
|---------|-------|
| Entry through curtain | Bass impact + atmosphere shift |
| Bouncer speaking Czech | Subtitle whoosh |
| Bros flash wristbands | Subtle party horn (ironic) |
| VIP bathroom entry | Echo shift, quieter music |
| NFT scan | Digital acquisition chime |

### Comedy Audio Integration
- **Achievement sound** when bros first enter believing they "intimidated" their way in
- **Bouncer deadpan** with hidden amusement
- **Vanessa breathy** vape-speak delivery
- **Sound alchemist** pretentious DJ announce
...
### Direct Access
| From | Direction | Notes |
|------|-----------|-------|
| Kebab Alley | Back entrance | Milk crate climbing shortcut |
| Opera Ruins District | Main alley | Primary approach |

### Thematic Connections
- **Wristbands from Clock Square** required for entry
- **Vape Witch Vanessa** connects to couchsurfing network
- **NFT hunt** connects to broader collectible quest
- **Club Flyers** quest connects to other nightlife locations
...
- **Target FPS**: 60
- **Memory budget**: 45MB
- **Particle budget**: 35 (fog, vape clouds, LED effects)

### Optimization Notes
- Fog effects simplified on older devices
- LED underglow uses texture animation, not real-time lighting
- Crowd NPCs use LOD system based on distance
- Chandelier sparkle is pre-baked animation
...
- [ ] **All NPCs functional**
- [ ] **Time variations working**
- [ ] **Quests triggering correctly**
- [ ] **NFT hunt accessible after Bravado check**
...
- **CRITICAL**: Club MUST be inaccessible before wristband acquisition
- Bouncer's Czech dialogue needs proper voice acting
- "I'm 7!" reveal must land perfectly - pause timing is essential
- Bros' denial ("themed birthday party for VIPs") is the joke
- Wristbands remain visible on bros throughout club visit AND rest of game
- Patrons may comment on wristbands during interactions
- VIP bathroom NFT hunt requires wristband scene to be complete first
- Children's party easter egg should be subtle background element
- Visit count affects bouncer dialogue pool selection
